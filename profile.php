...
<html lang="en">
  ...
  <body>
    ...
    <div class="mobile_nav">
      <div class="nav_bar">
        <img src="simage/<?php echo $image; ?>" class="mobile_profile_image" alt="">
        <i class="fa fa-bars nav_btn"></i>
      </div>
      <div class="mobile_nav_items">
        <a href="index.php" onclick="makeActive(this)" class="active"><i class="fa fa-tachometer"></i><span>Dashboard</span></a>
        <a href="profile.php" onclick="makeActive(this)" class="active-link"><i class="fa fa-user"></i><span>Profile</span></a>
        ...
        <div class="container-fluid">
          ...
          <div class="row pt-4">
            <div class="col-12 shadow  d-flex flex-row justify-content-center">
                <img src="simage/<?php echo $image; ?>" class="profile_image" alt="" style="width:20%;" class="profile-img shadow">
            </div>
          </div>
          <div class="row pt-3 mt-3 profile-details shadow" style="height:280px;">
              <div class="col-12 border-bottom pt-2 bg-dark text-white">
                <span class="mx-3"><b>Name &nbsp&nbsp&nbsp:</b> <span class="profile-name ml-4"><?php echo $user_data['s_name'];?></span></span>
              </div>
              <div class="col-12 border-bottom pt-2">
                <span class="mx-3"><b>ID&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</b>
                  <span class="profile-id ml-4"><?php echo $user_data['s_id'];?></span></span>
              </div>
              <div class="col-12 border-bottom pt-2 bg-dark text-white">
                  <span class="mx-3"><b>Branch&nbsp:</b> <span class="profile-branch ml-4"><?php echo $user_data['s_branch'];?></span></span>
              </div>
              <div class="col-12 border-bottom pt-2">
                                  <span class="mx-3"><b>Year&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:</b>
                                    <span class="profile-year ml-4"><?php echo $user_data['s_year'];?></span></span>
              </div>
              <div class="col-12 border-bottom pt-2 bg-dark text-white">
                <span class="mx-3"><b>E-mail&nbsp&nbsp&nbsp:</b>
                  <span class="profile-year ml-4"><?php echo $user_data['s_mail'];?></span></span>
              </div>
          </div>
        </div>
    </div>
